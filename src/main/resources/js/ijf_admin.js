...
addEditForm:function (sRow)
{
	...
	//Prep for permissions
	   ...
	   // mwf_reloadFramework(fw,inContainerId, false);
		...
		var lookup = ["attachmentlist","attachmentlistgrid","attachmentmanaged","attachmentlisttree","attachmentupload","button","chart-bar","chart-pie","checkbox","commentlist","datebox","dropdown","dropdownwithpicker","formbuttons","formbuttonsforpopup","GRID","GRIDHTML","grouppicker","grouppickermulti","html","htmleditor","historylist","iframe","itemlist","itemlistHTML","itemtree","muiButton","muiCardList","muiDrawer","muiIcon","muiRadio","muiSelect","muiTextarea","muiTextbox","multiselect","navigatetoform","Reference Editor","subform","openurl","openpopform","radio","reportbutton","tabmenu","textarea","textbox","userpicker","userpickermulti","workflowbuttons"];
