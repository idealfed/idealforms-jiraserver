...
renderAttachmentSPTree:function(inFormKey,item, inField, inContainer)
{
   ...
   //look for file attributes
    ...
    //commented out, running later in routine.
...
//selection.
	...
	if(managedFileName)
	{
	    var headerHtml = "<div id='"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadLabelId'>File: " + managedFileName + "<br> uploaded by " + sortedAttachments[0].CreatedByName + " on " + moment(sortedAttachments[0].CreatedDate).format('lll') + "</div>";
        ...
        var fileLoad = "<form enctype='multipart/form-data' id='"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadFormId'><input id='"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadFileId' type='file' name='file' onChange=\"javascript:if(ijfUtils.sharepointFilenameClean(this.value).indexOf('"+managedFileName+"')>-1){ijf.main.controlChanged('"+inFormKey+"_fld_"+inField.formCell+"');Ext.get('"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadLabelId').update('File Selected (hit save to upload):<br><span style=color:yellow>'+ijfUtils.sharepointFilenameClean(this.value.split('\\\\')[this.value.split('\\\\').length-1])+'</span>');ijfUtils.gridSpUploadFile(event,'"+inFormKey+'_ctr_'+inField.formCell.replace(/,/g,"_")+"','"+inFormKey+'_fld_'+inField.formCell+"','" + ijf.currentItem.key + "');} else {ijfUtils.modalDialogMessage('Error','Sorry, you must select a file named: <br><br>"+managedFileName+"');}\"></form>";
    ...
    else
    {
        ...
        var fileLoad = "<form enctype='multipart/form-data' id='"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadFormId'><input id='"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadFileId' type='file' name='file' onChange=\"javascript:ijf.main.controlChanged('"+inFormKey+"_fld_"+inField.formCell+"');Ext.get('"+inFormKey+'_fld_'+inField.formCell.replace(/,/g,"_")+"UploadLabelId').update('File Selected (hit save to upload):<br><span style=color:yellow>'+ijfUtils.sharepointFilenameClean(this.value.split('\\\\')[this.value.split('\\\\').length-1])+'</span>');ijfUtils.gridSpUploadFile(event,'"+inFormKey+'_ctr_'+inField.formCell.replace(/,/g,"_")+"','"+inFormKey+'_fld_'+inField.formCell+"','" + ijf.currentItem.key + "'); \"></form>";
	}
						...
						if(link.outwardIssue)
						{
							...
							if(inField.referenceFilter != link.outwardIssue.fields.issuetype.name)
							{
								...
								inChildren.push({
									...
									"summary": ijfUtils.sanitize(link.outwardIssue.fields.summary),
