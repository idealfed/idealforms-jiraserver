...
///////////START JIRA UTILS
	...
	getJiraIssue(inKey, onSuccess, onError)
	{
		ijfUtils.footLog("Calling get issue for " + inKey);
		var retData = null;
		jQuery.ajax({
	...
	getJiraIssueMeta(inKey, onSuccess, onError)
	{
		ijfUtils.footLog("Calling get issue for " + inKey);
		var retData = null;
		jQuery.ajax({
	...
	getJiraComments(inKey, onSuccess, onError)
	{
		ijfUtils.footLog("Calling get fields");
		var retData = null;
		jQuery.ajax({
	...
	getJiraFields(onSuccess, onError)
	{
		ijfUtils.footLog("Calling get fields");
		var retData = null;
		jQuery.ajax({
